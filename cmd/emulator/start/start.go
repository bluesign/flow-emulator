...
type Config struct {
	...
	RedisURL                  string        `default:"" flag:"redis-url" info:"redis-server URL for persisting redis storage adapters ( redis://[[username:]password@]host[:port][/database] ) "`
	SqliteURL                 string        `default:"" flag:"sqlite-url" info:"sqlite db URL for persisting sqlite storage adapters "`
}
