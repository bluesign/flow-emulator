...
// SDKAdapter wraps an emulated blockchain and implements the RPC handlers
...
func (b *SDKAdapter) GetLatestBlockHeader(
	...
	*sdk.BlockHeader,
	...
	block, blockStatus, err := b.emulator.GetLatestBlock()
	if err != nil {
	...
	return &blockHeader, BlockStatus(blockStatus), nil
}
...
func (b *SDKAdapter) GetBlockHeaderByHeight(
	...
	*sdk.BlockHeader,
	...
	block, blockStatus, err := b.emulator.GetBlockByHeight(height)
	if err != nil {
		return nil, BlockStatusUnknown, status.Error(codes.Internal, err.Error())
	}
	blockHeader := sdk.BlockHeader{
...
func (b *SDKAdapter) GetBlockHeaderByID(
	...
	*sdk.BlockHeader,
	...
	block, blockStatus, err := b.emulator.GetBlockByID(convert.SDKIdentifierToFlow(id))
	if err != nil {
...
func (b *SDKAdapter) GetLatestBlock(
	...
	*sdk.Block,
	...
	flowBlock, blockStatus, err := b.emulator.GetLatestBlock()
	if err != nil {
		return nil, BlockStatusUnknown, status.Error(codes.Internal, err.Error())
	}
	block := sdk.Block{
	...
	return &block, BlockStatus(blockStatus), nil
}
...
func (b *SDKAdapter) GetBlockByHeight(
	...
	*sdk.Block,
	...
	flowBlock, blockStatus, err := b.emulator.GetBlockByHeight(height)
	if err != nil {
		return nil, BlockStatusUnknown, status.Error(codes.Internal, err.Error())
	}
	block := sdk.Block{
...
func (b *SDKAdapter) GetBlockByID(
	...
	*sdk.Block,
	...
	flowBlock, blockStatus, err := b.emulator.GetBlockByID(convert.SDKIdentifierToFlow(id))
	if err != nil {
		return nil, BlockStatusUnknown, status.Error(codes.Internal, err.Error())
	}
	block := sdk.Block{
