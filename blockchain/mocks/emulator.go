...
// Source: github.com/onflow/flow-emulator/blockchain (interfaces: Emulator)
...
func (m *MockEmulator) ServiceKey() blockchain.ServiceKey {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ServiceKey")
	ret0, _ := ret[0].(blockchain.ServiceKey)
	return ret0
}
